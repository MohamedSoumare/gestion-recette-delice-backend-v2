...
describe("Recipe tests", () => {
  ...
  it("can not be created", async () => {
    const recipe = { title: null, type: "dessert", description: "pâte à base de farine", ingredient: "farine" };
    try {
      await Recipe.create(
        recipe.title,
        recipe.type,
  ...
  it("can update a recipe", async () => {
    const updatedData = { title: "updated crepe", type: "dessert", description: "updated description", ingredient: "updated ingredient" };
